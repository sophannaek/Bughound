			...
			<div class="collapse navbar-collapse" id="navbarText">
				<ul class="navbar-nav mr-auto">
					...
					<li class="nav-item active">
						<a class="nav-link" href="#">Edit Bug</a>
					</li>
		...
		<div class='container-fluid'>
			...
			<form action='uploadAttachment.php' method='POST' enctype="multipart/form-data">
				<p>
					...
					<button type='submit' formaction='openAttachment.php' class='btn btn-info'>Open</button>
				</p>
				<hr/>
				<p>
					<input type="hidden" id='bug_id' name='bug_id' value='<?php echo $bug_id; ?>'>
					<input type="file" name="attachment" />
					<input type='submit' value="Add Attachment" class='btn btn-secondary'/>
				</p>
		</form>
